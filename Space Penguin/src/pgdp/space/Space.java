...
public final class Space {
    ...
    public static void main(String[] args) {
        ...
        connections.put(beta, List.of(new BeaconConnection(beta, NORMAL), new BeaconConnection(gamma, WORMHOLE), new BeaconConnection(delta, NORMAL)));
        connections.put(gamma, List.of(new BeaconConnection(alpha, NORMAL), new BeaconConnection(gamma, NORMAL), new BeaconConnection(epsilon, NORMAL)));
