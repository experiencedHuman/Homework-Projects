...
public class IntDoubleList {
    ...
    //helper method
    public void setLastElement(IntDoubleListElement lastElement) {
        this.tail = lastElement;
    }

    //helper method
    public void setFirstElement(IntDoubleListElement firstElement) {
        this.head = firstElement;
    }

    //helper method - appends another list to this list
    public void appendList(IntDoubleList nextList) {
        this.tail.next = nextList.getFirstElement();
        this.tail = nextList.getLastElement();
    }
